...
import com.github.nenadjakic.investiq.currencyfetcher.model.CurrencyHistoryList
import com.github.nenadjakic.investiq.currencyfetcher.model.DateExchangeRate
import com.github.nenadjakic.investiq.currencyfetcher.model.YahooChartResponse
...
@Service
class YahooFinanceCurrencyFetcher(
    ...
    fun  fetchHistory(
        ...
        timestamps.forEachIndexed { idx, ts ->
            ...
            val rate = if (!usedInverse) {
                ...
                BigDecimal.ONE.divide(BigDecimal.valueOf(priceNullable), 12, java.math.RoundingMode.HALF_UP)
            }
